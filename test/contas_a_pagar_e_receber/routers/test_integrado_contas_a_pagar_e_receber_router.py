...
def test_deve_listar_contas_a_pagar_e_receber():
    ...
    assert response.json() == [
        {'id': 1, 'descricao': 'aluguel', 'valor': '100.0000000000', 'tipo': 'PAGAR', 'fornecedor': None, 'esta_baixada': False, 'valor_da_baixa': None, 'data_baixa': None,},
        {'id': 2, 'descricao': 'aluguel', 'valor': '100.0000000000', 'tipo': 'PAGAR', 'fornecedor': None, 'esta_baixada': False, 'valor_da_baixa': None, 'data_baixa': None,}
    ]
